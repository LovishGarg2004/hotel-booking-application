...
public class PricingRuleServiceImpl implements PricingRuleService {
    ...
    public PricingRule createRule(PricingRuleRequest request) {
        try {
            ...
            throw new RuntimeException("Failed to create pricing rule. Please try again later.", e);
        }
    }
    ...
    public List<PricingRule> getAllRules() {
        try {
            ...
            throw new RuntimeException("Failed to retrieve pricing rules. Please try again later.", e);
        }
    }
    ...
    public PricingRule getRuleById(UUID id) {
        try {
            ...
            throw new RuntimeException("Failed to retrieve pricing rule. Please try again later.", e);
        }
    }
    ...
    public PricingRule updateRule(UUID id, PricingRuleRequest request) {
        try {
            ...
            throw new RuntimeException("Failed to update pricing rule. Please try again later.", e);
        }
    }
    ...
    public void deleteRule(UUID id) {
        try {
            ...
            throw new RuntimeException("Failed to delete pricing rule. Please try again later.", e);
        }
    }
    ...
    public List<PricingRule> getRulesForHotel(UUID hotelId) {
        try {
            ...
            throw new RuntimeException("Failed to retrieve pricing rules for hotel. Please try again later.", e);
        }
    }
}
