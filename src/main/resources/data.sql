...
INSERT INTO users VALUES
  ...
  ('22222222-2222-2222-2222-222222222222', 'Bob', 'bob@example.com', 'pass456', '1985-05-05', '0987654321', 'USER', CURRENT_TIMESTAMP),
  ('33333333-3333-3333-3333-333333333333', 'Charlie', 'charlie@example.com', 'pass789', '1992-03-15', '1112223333', 'HOTEL_MANAGER', CURRENT_TIMESTAMP),
  ('44444444-4444-4444-4444-444444444444', 'Diana', 'diana@example.com', 'pass321', '1988-07-22', '2223334444', 'USER', CURRENT_TIMESTAMP),
  ('55555555-5555-5555-5555-555555555555', 'Eve', 'eve@example.com', 'pass654', '1995-12-10', '3334445555', 'USER', CURRENT_TIMESTAMP);
